 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2017 Visitors. All rights reserved | Design by Steven Lee <a href="http://w3layouts.com">Steven Lee</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
...
<script src="{{asset('public/backend/js/bootstrap.j')}}s"></script>
